...
import VLabel from '../../Components/VLable.vue';
...
const handleSignup = async () => {
  if (!isLoading.value) {
    ...
    // router.push({ name: '/' })
    Inertia.visit('/banking', {method: "GET"});
            ...
            <div class="columns signup-columns" :class="[step !== 0 && 'is-hidden']">
              <div class="column is-4 is-offset-1">
                ...
                <div class="signup-card">
                  <form class="signup-form is-mobile-spaced" @submit.prevent="handleRegister">
                    <div class="columns is-multiline">
                      <div class="column is-6">
                        <VField>
                          <VControl>
                            <VInput type="text" v-model="form.name" autocomplete="given-name" />
                      ...
                      <div class="column is-12">
                        <VField>
                          <VControl>
                            <VInput type="text" v-model="form.email" autocomplete="email" />
                      ...
                      <div class="column is-12">
                        <VField>
                          <VControl>
                            <VInput type="password" v-model="form.password" autocomplete="email" />
                      ...
                      <div class="column is-12">
                        <VField>
                          <VControl>
                            <VInput type="password" v-model="form.password_confirmation" autocomplete="email" />
                    ...
                    <div class="button-wrap has-help">
                      <button
                        class="button button v-button is-rounded is-bold is-big is-fullwidth is-primary"
                        type="submit"
                      >
                        Continue
                      </button>
            ...
            <div class="columns signup-columns" :class="[step !== 1 && 'is-hidden']">
              <form class="column is-8" @submit.prevent>
                ...
                <div class="button-wrap is-centered has-text-centered">
                  <button class="button button v-button is-rounded is-bold is-big is-fullwidth is-primary" @click="step++">
                    Continue
                  </button>
                </div>
              </form>
