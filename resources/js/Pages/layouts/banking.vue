...
import type { SidebarTheme } from "../../Components/navigations/sidebar.vue";
import Sidebar from "../../Components/navigations/sidebar.vue";
import { usePanels } from "../../store/panels";
import { useViewWrapper } from "../../store/viewWrapper";
    ...
    >
      ...
      <KeepAlive>
        ...
        <Sidebar :theme="props.theme" :is-open="isDesktopSidebarOpen">
            <template v-slot:links>
                ...
                <li>
                    <a
                        :class="[
                            activeMobileSubsidebar === 'dashboard' &&
                                'is-active',
                        ]"
                ...
                <li>
                    <a
                        :class="[
                            activeMobileSubsidebar === 'layout' && 'is-active',
                        ]"
                ...
                <li>
                    <a
                        :class="[
                            activeMobileSubsidebar === 'elements' &&
                                'is-active',
                        ]"
                ...
                <li>
                    <a
                        :class="[
                            activeMobileSubsidebar === 'components' &&
                                'is-active',
                        ]"
        ...
        <div
            ...
            :class="
                subSidebarVisible ? 'sub-sidebar-open' : 'sub-sidebar-close'
            "
        >
            ...
            <div class="inner" data-simplebar>
                <ul>
                    <li><Link href="/banking">Banking v1</Link></li>
                    <li><Link href="/banking2">Banking v2</Link></li>
                </ul>
            </div>
        </div>
        <!-- </KeepAlive> -->
